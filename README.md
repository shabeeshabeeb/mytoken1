...
# Public variables
The code starts with assigning the name and abbreviation of the token using a string variable. The  name is token name is  'shabee' and abbreviation as 'sb'
# Mapping variable
...
contract MyToken {
    ...
    string public tokenName = "shabee";
